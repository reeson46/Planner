...
function renameAddPopover() {
  $('.rename-add-icon-sidebar').popover({
    html: true,
    sanitize: false,
    content: function () {
...
$(document).ready(function () {
  ...
  // RENAME OR ADD ICON
  $('.rename-add-icon-sidebar').on('click', function () {
  ...
  // DELETE ICON
  $(document).on('click', '.delete-icon-sidebar', function () {
...
$(document).on('click', function (e) {
  $('.rename-add-icon-sidebar').each(function () {
