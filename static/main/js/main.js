          ...
          $.ajax({
            ...
            success: function (json) {
              ...
              if (sender == 'sidebar' && action == 'rename'){
                ...
                if(type == 'board'){
                  $('.board-link[value='+id+']').html(json.name)
                }
